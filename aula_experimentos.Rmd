...
# Set up Potential outcomes and units
set.seed(10)
n1 <- 10
n2 <- 16
n3 <- 20
...
y0_obs <- y1*simple_treatment
y0_obs <- y0_obs[y0_obs != 0]

# erro padrão
t.test(y1_obs, y0_obs)$stderr
```
